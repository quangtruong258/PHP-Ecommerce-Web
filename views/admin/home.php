                ...
                <div class="row">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="ps-3">
                                        <h6>
                                            <?php
                                            $doanhthu = 0;
                                            foreach ($doanhthuhomnay as $item) {
                                                $doanhthu += $item["total"];
                                            }
                                            echo "" . number_format($doanhthu, 3, ",", ".") . " đ ";
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card info-card customers-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Khách hàng đã mua<span></span></h5>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card info-card customers-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Khách hàng truy cập hôm nay<span> </span></h5>
