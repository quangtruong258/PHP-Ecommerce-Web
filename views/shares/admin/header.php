...
<body>
    ...
    <header id="header" class="header fixed-top d-flex align-items-center">
        ...
        <div class="d-flex align-items-center justify-content-between">
            <a href="?r=admin" class="logo d-flex align-items-center">
            ...
            <ul class="d-flex align-items-center">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="theme/assets/img/messages-1.jpg" alt="" class="rounded-circle">
                                <div>
                                    <h4>Maria Hudson</h4>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="theme/assets/img/messages-2.jpg" alt="" class="rounded-circle">
                                <div>
                                    <h4>Anna Nelson</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                    <p>6 hrs. ago</p>
                        ...
                        <li class="message-item">
                            <a href="#">
                                <img src="theme/assets/img/messages-3.jpg" alt="" class="rounded-circle">
                                <div>
                                    <h4>David Muldon</h4>
                                    <p>Velit asperiores et ducimus soluta repudiandae labore officia est ut...</p>
                                    <p>8 hrs. ago</p>
                ...
                <li class="nav-item dropdown pe-3">
                    <a class="nav-link nav-profile d-flex align-items-center pe-0" href="#" data-bs-toggle="dropdown">
                        <!-- <img src="uploads/
                        <?php //echo $_SESSION['avata'] ?? 'assets/img/profile-img.jpg'; ?>"
                        
                        alt="Profile" class="rounded-circle"> -->
                        <span class="d-none d-md-block dropdown-toggle ps-2">
                            <?php
                            if (isset($_SESSION['empName'])) {
                                echo "Xin chào: " . $_SESSION['empName'] . "";

                            
                                //echo "<a class='btn btn-danger' href= '?r=logout'> Logout</a>";
                            }
                            ?>
                        </span>
                    ...
                    <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                        ...
                        <li>
                            <a class="dropdown-item d-flex align-items-center" href="?r=editprofile">
    ...
    <aside id="sidebar" class="sidebar">
        ...
        <ul class="sidebar-nav" id="sidebar-nav">
            ...
            <?php
                if (!isset(  $_SESSION['empName'] )) {
                    echo "<a class='nav-link' href= '?r=admin/register'> <i class='bi bi-grid'></i> <span>Đăng ký tài khoản</span></a>";
                }
                ?>
            </li>
            ...
            <li class="nav-item">
                <?php
                if (!isset(  $_SESSION['empName'] )) {
                    echo "<a class='nav-link' href= '?r=admin/login'> <i class='bi bi-grid'></i> <span>Đăng nhập</span></a>";
                }
                ?>
            </li>
            ...
            <li class="nav-item">
                <?php
                if (isset(  $_SESSION['empName'] )) {
                    echo "<a class='nav-link' href= '?r=admin/logout'> <i class='bi bi-grid'></i> <span>Đăng xuất</span></a>";
                }
                ?>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link " href="?r=admin/quanlyhoa">
            ...
            <li class="nav-item">
                <a class="nav-link " href="?r=admin/quanlyhoadon">
                    <i class="bi bi-grid"></i>
